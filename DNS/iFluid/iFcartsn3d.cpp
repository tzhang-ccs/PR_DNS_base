	...
	L_size = 1;
	    ...
	    if (setInitialVelocity != NULL)
            ...
            for (id = 0; id < numprocs; id++)
            {
                ...
                {
                    MPI_Send((POINTER)(U_buff),L_size,MPI_DOUBLE,id,1,MPI_COMM_WORLD);
                    MPI_Send((POINTER)(V_buff),L_size,MPI_DOUBLE,id,2,MPI_COMM_WORLD);
                    MPI_Send((POINTER)(W_buff),L_size,MPI_DOUBLE,id,3,MPI_COMM_WORLD);
                }
            }
